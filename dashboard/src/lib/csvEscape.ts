/**
 * Shared CSV cell escaper for all dashboard-package CSV emitters.
 *
 ...
 *
 * NOTE: the root package cannot import this file (separate npm packages);
 * src/utils/csvEscape.ts is its intentionally-duplicated counterpart.
 */
